...
%>
<!-- Testa Navbar -->
<nav class="navbar navbar-expand-lg navbar-light bg-primary" style="background-image:url('${pageContext.request.contextPath}/nav');">
...
<!-- Corpo Pagina -->
<div class="container-fluid corpo" style="background-image:url('${pageContext.request.contextPath}/background');">
	<div class="row">
		<div class="col"></div>
